...
const mockAttachments: Record<string, Attachment[]> = {
  privacy: [
    { id: 'att-n1', fileName: '개인정보처리방침_변경사항_2026.pdf', fileSize: 1536000, mimeType: 'application/pdf', url: '#' },
    { id: 'att-n2', fileName: '개인정보처리방침_전문.pdf', fileSize: 2457600, mimeType: 'application/pdf', url: '#' },
  ],
  update: [
  ...
  report: [
    { id: 'att-1', fileName: '2026년_보고서_양식_v2.docx', fileSize: 245760, mimeType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', url: '#' },
    { id: 'att-2', fileName: '보고서_작성_가이드.pdf', fileSize: 1048576, mimeType: 'application/pdf', url: '#' },
  ],
  project: [
...
export const mockPosts: BoardPost[] = [
  ...
  { id: 2, boardId: 'notice', title: '개인정보처리방침 변경 안내', author: '관리자', createdAt: '2026-02-05', views: 218, isPublic: true, attachments: mockAttachments.privacy, content: '개인정보보호법 개정에 따라 개인정보처리방침이 2026년 3월 1일부터 변경됩니다.\n\n주요 변경사항:\n1. 개인정보 보유기간 조정\n2. 제3자 제공 동의 절차 강화\n3. 개인정보 파기 절차 명확화\n\n자세한 내용은 첨부파일을 참조하시기 바랍니다.' },
  { id: 3, boardId: 'notice', title: '2026년 1분기 업데이트 예정 사항', author: '관리자', createdAt: '2026-02-01', views: 567, attachments: mockAttachments.update, content: '2026년 1분기 시스템 업데이트 예정 사항을 안내드립니다.\n\n1. 대시보드 UI 개편 (2월)\n2. 모바일 반응형 개선 (2월)\n3. 전자결재 워크플로우 기능 추가 (3월)\n4. 통계 리포트 자동 생성 기능 (3월)\n\n각 기능은 순차적으로 배포될 예정입니다.' },
  ...
  { id: 17, boardId: 'notice', title: '구 시스템 데이터 이관 완료 안내', author: '관리자', createdAt: '2026-01-10', views: 274, isNew: true, isPublic: true, attachments: mockAttachments.migration, content: '구 시스템에서 신규 시스템으로의 데이터 이관이 완료되었습니다.\n\n이관 데이터:\n- 인사 기본정보\n- 결재 이력 (최근 3년)\n- 게시판 데이터\n\n데이터 누락이나 오류가 있을 경우 관리자에게 문의해 주세요.' },
  { id: 18, boardId: 'notice', title: '비밀번호 변경 주기 안내 (90일)', author: '관리자', createdAt: '2026-01-05', views: 412, isNew: true, isPublic: true, content: '정보보안 정책에 따라 비밀번호는 90일마다 변경해야 합니다.\n\n■ 비밀번호 규칙\n- 8자 이상, 영문 대/소문자 + 숫자 + 특수문자 조합\n- 이전 3회 사용한 비밀번호 재사용 불가\n- 연속된 문자/숫자 3자 이상 사용 불가\n\n변경 기한이 지나면 로그인 시 강제 변경 화면이 표시됩니다.' },

  // 자유게시판
  { id: 6, boardId: 'free', title: '새로운 보고서 양식 공유합니다', author: '김철수', createdAt: '2026-02-07', views: 45, isNew: true, attachments: mockAttachments.report, content: '안녕하세요.\n\n이번에 새로 개정된 보고서 양식을 공유드립니다.\n기존 양식 대비 주요 변경사항은 다음과 같습니다.\n\n1. 요약 섹션 추가\n2. 첨부파일 목록 양식 변경\n3. 승인 라인 표기 방식 변경\n\n첨부파일을 확인해 주세요.' },
  { id: 7, boardId: 'free', title: '이번 주 회의 일정 변경 건', author: '이영희', createdAt: '2026-02-06', views: 78, content: '이번 주 정기 회의 일정이 변경되었습니다.\n\n변경 전: 2/7(금) 14:00\n변경 후: 2/7(금) 16:00\n\n장소는 동일하게 3층 대회의실입니다.\n참석 부탁드립니다.' },
  { id: 8, boardId: 'free', title: '프로젝트 진행 현황 공유', author: '박민수', createdAt: '2026-02-05', views: 123, attachments: mockAttachments.project, content: 'TerraNova 프로젝트 진행 현황을 공유드립니다.\n\n■ 프론트엔드: 80% 완료\n■ 백엔드: 60% 완료\n■ DB 설계: 완료\n■ 테스트: 진행 중\n\n상세 일정은 첨부 문서를 참고해 주세요.' },
