...
export default function SystemMenuSidebar({ systemId }: Props) {
  ...
  return (
    <>
      ...
      >
        {/* 헤더: 접기/펼치기 */}
        <div className={`flex items-center h-10 border-b border-gray-100 dark:border-gray-800 ${showCollapsed ? 'justify-center' : 'justify-end pr-2'}`}>
          <button
            onClick={toggle}
        ...
        {system && (
          <div className="border-b border-gray-100 dark:border-gray-800">
            <div className={`flex items-center h-10 whitespace-nowrap ${showCollapsed ? 'justify-center' : 'gap-2 px-4'}`}>
