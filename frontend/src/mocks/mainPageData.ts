...
export const mockPosts: BoardPost[] = [
  ...
  { id: 17, boardId: 'notice', title: '구 시스템 데이터 이관 완료 안내', author: '관리자', createdAt: '2026-01-10', views: 274, isNew: true, isPublic: true, content: '구 시스템에서 신규 시스템으로의 데이터 이관이 완료되었습니다.\n\n이관 데이터:\n- 인사 기본정보\n- 결재 이력 (최근 3년)\n- 게시판 데이터\n\n데이터 누락이나 오류가 있을 경우 관리자에게 문의해 주세요.' },
